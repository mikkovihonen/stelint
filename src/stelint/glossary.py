        ...
        for glossary in glossaries:
            ...
            if glossary_path.exists():
                ...
                if glossary_path.resolve() == _CONSTANTS_FILE.resolve():
                    raise ValueError("asd-ste100_base.jsonl must not be referenced in glossaries.yaml. It is always loaded first with the lowest cardinality and cannot be overridden.")
...
def add_to_project_glossary(namespace: str, name: str, key: str, value, project_glossary_path: str | None = None):
    ...
    new_entry = {"namespace": namespace, "name": name, "type": "mapping", "data": existing_data}
