...
class TestPolysemyDetection:
    ...
    def test_high_frequency_same_meaning(self):
        ...
        nlp = __import__("spacy").load("en_core_web_sm")
        doc = nlp("The process runs. The process provides. The process uses. The process handles. This process is key.")
        issues = check_key_words(doc)
    ...
    def test_no_false_positives(self):
        ...
        nlp = __import__("spacy").load("en_core_web_sm")
        doc = nlp("The container holds data. The container stores files. The container image is built. The container network is isolated.")
        issues = check_key_words(doc)
    ...
    def test_mixed_document(self):
        ...
        nlp = __import__("spacy").load("en_core_web_sm")
        doc = nlp("The host holds a process. The host port is open. Turn on the light. The room is light.")
        issues = check_key_words(doc)
